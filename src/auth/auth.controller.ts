...
export class AuthController {
  ...
  async signupWithOtp(@Body() signupDto: SignupWithOtpDto) {
    return await this.authService.signupWithOtp(signupDto);
  }

  @Post("verify-email-otp")
  async verifyEmailOtp(@Body() verifyOtpDto: VerifyOtpDto) {
    return await this.authService.confirmEmailWithOtp(
      verifyOtpDto.email,
      verifyOtpDto.otp
    );
  }
  ...
  @Post("login-with-jwt")
  async loginWithJwt(@Body() loginDto: LoginDto) {
